...
color mapPopulationToColor(int population) {
  ...
  if (population <= 1500) {
    return color(178,136,192);
  } else if (population <= 3000) {
    return color(126,90,155);
  } else if (population <= 6000) {
    return color(99,69,138);
  } else {
    return color(154,72,208);
  }
}
...
//Legend for area
  ...
  for (int i = 0; i < populationRanges.length - 1; i++) {
    ...
    if (i == 0) {
      fill(color(178,136,192)); 
    } else if (i == 1) {
      fill(color(126,90,155)); 
    } else if (i == 2) {
      fill(color(99,69,138)); 
    } else {
      fill(color(154,72,208)); 
    }
